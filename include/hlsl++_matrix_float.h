...
hlslpp_inline float1x1 &operator+=(float1x1 &m1, const float1x1 &m2)
{
	m1 = m1 + m2;
	return m1;
}
hlslpp_inline float1x2 &operator+=(float1x2 &m1, const float1x2 &m2)
{
	m1 = m1 + m2;
	return m1;
}
hlslpp_inline float1x3 &operator+=(float1x3 &m1, const float1x3 &m2)
{
	m1 = m1 + m2;
	return m1;
}
hlslpp_inline float1x4 &operator+=(float1x4 &m1, const float1x4 &m2)
{
	m1 = m1 + m2;
	return m1;
}
hlslpp_inline float2x1 &operator+=(float2x1 &m1, const float2x1 &m2)
{
	m1 = m1 + m2;
	return m1;
}
hlslpp_inline float3x1 &operator+=(float3x1 &m1, const float3x1 &m2)
{
	m1 = m1 + m2;
	return m1;
}
hlslpp_inline float4x1 &operator+=(float4x1 &m1, const float4x1 &m2)
{
	m1 = m1 + m2;
	return m1;
}
hlslpp_inline float2x2 &operator+=(float2x2 &m1, const float2x2 &m2)
{
	m1 = m1 + m2;
	return m1;
}
hlslpp_inline float2x3 &operator+=(float2x3 &m1, const float2x3 &m2)
{
	m1 = m1 + m2;
	return m1;
}
hlslpp_inline float2x4 &operator+=(float2x4 &m1, const float2x4 &m2)
{
	m1 = m1 + m2;
	return m1;
}
hlslpp_inline float3x2 &operator+=(float3x2 &m1, const float3x2 &m2)
{
	m1 = m1 + m2;
	return m1;
}
hlslpp_inline float4x2 &operator+=(float4x2 &m1, const float4x2 &m2)
{
	m1 = m1 + m2;
	return m1;
}
hlslpp_inline float3x3 &operator+=(float3x3 &m1, const float3x3 &m2)
{
	m1 = m1 + m2;
	return m1;
}
hlslpp_inline float3x4 &operator+=(float3x4 &m1, const float3x4 &m2)
{
	m1 = m1 + m2;
	return m1;
}
hlslpp_inline float4x3 &operator+=(float4x3 &m1, const float4x3 &m2)
{
	m1 = m1 + m2;
	return m1;
}
hlslpp_inline float4x4 &operator+=(float4x4 &m1, const float4x4 &m2)
{
	m1 = m1 + m2;
	return m1;
}
...
hlslpp_inline float2x3 operator+(const float2x3 &m, const float1 &f)
{
	n128 perm = _hlslpp_perm_xxxx_ps(f.vec);
	return float2x3(_hlslpp_add_ps(m.vec0, perm), _hlslpp_add_ps(m.vec1, perm));
}
hlslpp_inline float3x2 operator+(const float3x2 &m, const float1 &f)
{
	n128 perm = _hlslpp_perm_xxxx_ps(f.vec);
	return float3x2(_hlslpp_add_ps(m.vec0, perm), _hlslpp_add_ps(m.vec1, perm));
}
hlslpp_inline float2x4 operator+(const float2x4 &m, const float1 &f)
{
	n128 perm = _hlslpp_perm_xxxx_ps(f.vec);
	return float2x4(_hlslpp_add_ps(m.vec0, perm), _hlslpp_add_ps(m.vec1, perm));
}
hlslpp_inline float4x2 operator+(const float4x2 &m, const float1 &f)
{
	n128 perm = _hlslpp_perm_xxxx_ps(f.vec);
	return float4x2(_hlslpp_add_ps(m.vec0, perm), _hlslpp_add_ps(m.vec1, perm));
}
hlslpp_inline float3x3 operator+(const float3x3 &m, const float1 &f)
{
	n128 perm = _hlslpp_perm_xxxx_ps(f.vec);
	return float3x3(_hlslpp_add_ps(m.vec0, perm), _hlslpp_add_ps(m.vec1, perm), _hlslpp_add_ps(m.vec2, perm));
}
hlslpp_inline float3x4 operator+(const float3x4 &m, const float1 &f)
{
	n128 perm = _hlslpp_perm_xxxx_ps(f.vec);
	return float3x4(_hlslpp_add_ps(m.vec0, perm), _hlslpp_add_ps(m.vec1, perm), _hlslpp_add_ps(m.vec2, perm));
}
hlslpp_inline float4x3 operator+(const float4x3 &m, const float1 &f)
{
	n128 perm = _hlslpp_perm_xxxx_ps(f.vec);
	return float4x3(_hlslpp_add_ps(m.vec0, perm), _hlslpp_add_ps(m.vec1, perm), _hlslpp_add_ps(m.vec2, perm));
}
...
{
	n128 perm = _hlslpp_perm_xxxx_ps(f.vec);
	return float2x3(_hlslpp_sub_ps(m.vec0, perm), _hlslpp_sub_ps(m.vec1, perm));
}
hlslpp_inline float3x2 operator-(const float3x2 &m, const float1 &f)
{
	n128 perm = _hlslpp_perm_xxxx_ps(f.vec);
	return float3x2(_hlslpp_sub_ps(m.vec0, perm), _hlslpp_sub_ps(m.vec1, perm));
}
hlslpp_inline float2x4 operator-(const float2x4 &m, const float1 &f)
{
	n128 perm = _hlslpp_perm_xxxx_ps(f.vec);
	return float2x4(_hlslpp_sub_ps(m.vec0, perm), _hlslpp_sub_ps(m.vec1, perm));
}
hlslpp_inline float4x2 operator-(const float4x2 &m, const float1 &f)
{
	n128 perm = _hlslpp_perm_xxxx_ps(f.vec);
	return float4x2(_hlslpp_sub_ps(m.vec0, perm), _hlslpp_sub_ps(m.vec1, perm));
}
hlslpp_inline float3x3 operator-(const float3x3 &m, const float1 &f)
{
	n128 perm = _hlslpp_perm_xxxx_ps(f.vec);
	return float3x3(_hlslpp_sub_ps(m.vec0, perm), _hlslpp_sub_ps(m.vec1, perm), _hlslpp_sub_ps(m.vec2, perm));
}
hlslpp_inline float3x4 operator-(const float3x4 &m, const float1 &f)
{
	n128 perm = _hlslpp_perm_xxxx_ps(f.vec);
	return float3x4(_hlslpp_sub_ps(m.vec0, perm), _hlslpp_sub_ps(m.vec1, perm), _hlslpp_sub_ps(m.vec2, perm));
}
hlslpp_inline float4x3 operator-(const float4x3 &m, const float1 &f)
{
	n128 perm = _hlslpp_perm_xxxx_ps(f.vec);
	return float4x3(_hlslpp_sub_ps(m.vec0, perm), _hlslpp_sub_ps(m.vec1, perm), _hlslpp_sub_ps(m.vec2, perm));
}
hlslpp_inline float4x4 operator-(const float4x4 &m, const float1 &f)
{
#if defined(HLSLPP_SIMD_REGISTER_FLOAT8)
...
{
	n128 perm = _hlslpp_perm_xxxx_ps(f.vec);
	return float2x3(_hlslpp_mul_ps(m.vec0, perm), _hlslpp_mul_ps(m.vec1, perm));
}
hlslpp_inline float3x2 operator*(const float3x2 &m, const float1 &f)
{
	n128 perm = _hlslpp_perm_xxxx_ps(f.vec);
	return float3x2(_hlslpp_mul_ps(m.vec0, perm), _hlslpp_mul_ps(m.vec1, perm));
}
hlslpp_inline float2x4 operator*(const float2x4 &m, const float1 &f)
{
	n128 perm = _hlslpp_perm_xxxx_ps(f.vec);
	return float2x4(_hlslpp_mul_ps(m.vec0, perm), _hlslpp_mul_ps(m.vec1, perm));
}
hlslpp_inline float4x2 operator*(const float4x2 &m, const float1 &f)
{
	n128 perm = _hlslpp_perm_xxxx_ps(f.vec);
	return float4x2(_hlslpp_mul_ps(m.vec0, perm), _hlslpp_mul_ps(m.vec1, perm));
}
hlslpp_inline float3x3 operator*(const float3x3 &m, const float1 &f)
{
	n128 perm = _hlslpp_perm_xxxx_ps(f.vec);
	return float3x3(_hlslpp_mul_ps(m.vec0, perm), _hlslpp_mul_ps(m.vec1, perm), _hlslpp_mul_ps(m.vec2, perm));
}
hlslpp_inline float3x4 operator*(const float3x4 &m, const float1 &f)
{
	n128 perm = _hlslpp_perm_xxxx_ps(f.vec);
	return float3x4(_hlslpp_mul_ps(m.vec0, perm), _hlslpp_mul_ps(m.vec1, perm), _hlslpp_mul_ps(m.vec2, perm));
}
hlslpp_inline float4x3 operator*(const float4x3 &m, const float1 &f)
{
	n128 perm = _hlslpp_perm_xxxx_ps(f.vec);
	return float4x3(_hlslpp_mul_ps(m.vec0, perm), _hlslpp_mul_ps(m.vec1, perm), _hlslpp_mul_ps(m.vec2, perm));
}
hlslpp_inline float4x4 operator*(const float4x4 &m, const float1 &f)
{
#if defined(HLSLPP_SIMD_REGISTER_FLOAT8)
...
{
	n128 perm = _hlslpp_perm_xxxx_ps(f.vec);
	return float2x3(_hlslpp_div_ps(m.vec0, perm), _hlslpp_div_ps(m.vec1, perm));
}
hlslpp_inline float3x2 operator/(const float3x2 &m, const float1 &f)
{
	n128 perm = _hlslpp_perm_xxxx_ps(f.vec);
	return float3x2(_hlslpp_div_ps(m.vec0, perm), _hlslpp_div_ps(m.vec1, perm));
}
hlslpp_inline float2x4 operator/(const float2x4 &m, const float1 &f)
{
	n128 perm = _hlslpp_perm_xxxx_ps(f.vec);
	return float2x4(_hlslpp_div_ps(m.vec0, perm), _hlslpp_div_ps(m.vec1, perm));
}
hlslpp_inline float4x2 operator/(const float4x2 &m, const float1 &f)
{
	n128 perm = _hlslpp_perm_xxxx_ps(f.vec);
	return float4x2(_hlslpp_div_ps(m.vec0, perm), _hlslpp_div_ps(m.vec1, perm));
}
hlslpp_inline float3x3 operator/(const float3x3 &m, const float1 &f)
{
	n128 perm = _hlslpp_perm_xxxx_ps(f.vec);
	return float3x3(_hlslpp_div_ps(m.vec0, perm), _hlslpp_div_ps(m.vec1, perm), _hlslpp_div_ps(m.vec2, perm));
}
hlslpp_inline float3x4 operator/(const float3x4 &m, const float1 &f)
{
	n128 perm = _hlslpp_perm_xxxx_ps(f.vec);
	return float3x4(_hlslpp_div_ps(m.vec0, perm), _hlslpp_div_ps(m.vec1, perm), _hlslpp_div_ps(m.vec2, perm));
}
hlslpp_inline float4x3 operator/(const float4x3 &m, const float1 &f)
{
	n128 perm = _hlslpp_perm_xxxx_ps(f.vec);
	return float4x3(_hlslpp_div_ps(m.vec0, perm), _hlslpp_div_ps(m.vec1, perm), _hlslpp_div_ps(m.vec2, perm));
}
hlslpp_inline float4x4 operator/(const float4x4 &m, const float1 &f)
{
#if defined(HLSLPP_SIMD_REGISTER_FLOAT8)
...
hlslpp_inline float1x1 &operator++(float1x1 &f)
{
	f = f + float1x1(1.0f);
	return f;
}
hlslpp_inline float1x2 &operator++(float1x2 &f)
{
	f = f + float1x2(1.0f);
	return f;
}
hlslpp_inline float1x3 &operator++(float1x3 &f)
{
	f = f + float1x3(1.0f);
	return f;
}
hlslpp_inline float1x4 &operator++(float1x4 &f)
{
	f = f + float1x4(1.0f);
	return f;
}
hlslpp_inline float2x1 &operator++(float2x1 &f)
{
	f = f + float2x1(1.0f);
	return f;
}
hlslpp_inline float3x1 &operator++(float3x1 &f)
{
	f = f + float3x1(1.0f);
	return f;
}
hlslpp_inline float4x1 &operator++(float4x1 &f)
{
	f = f + float4x1(1.0f);
	return f;
}
hlslpp_inline float2x2 &operator++(float2x2 &f)
{
	f = f + float2x2(1.0f);
	return f;
}
hlslpp_inline float2x3 &operator++(float2x3 &f)
{
	f = f + float2x3(1.0f);
	return f;
}
hlslpp_inline float3x2 &operator++(float3x2 &f)
{
	f = f + float3x2(1.0f);
	return f;
}
hlslpp_inline float2x4 &operator++(float2x4 &f)
{
	f = f + float2x4(1.0f);
	return f;
}
hlslpp_inline float4x2 &operator++(float4x2 &f)
{
	f = f + float4x2(1.0f);
	return f;
}
hlslpp_inline float3x3 &operator++(float3x3 &f)
{
	f = f + float3x3(1.0f);
	return f;
}
hlslpp_inline float3x4 &operator++(float3x4 &f)
{
	f = f + float3x4(1.0f);
	return f;
}
hlslpp_inline float4x3 &operator++(float4x3 &f)
{
	f = f + float4x3(1.0f);
	return f;
}
hlslpp_inline float4x4 &operator++(float4x4 &f)
{
	f = f + float4x4(1.0f);
	return f;
}
...
hlslpp_inline float1x1 operator++(float1x1 &f, int)
{
	float1x1 tmp = f;
	f = f + float1x1(1.0f);
	return tmp;
}
hlslpp_inline float1x2 operator++(float1x2 &f, int)
{
	float1x2 tmp = f;
	f = f + float1x2(1.0f);
	return tmp;
}
hlslpp_inline float1x3 operator++(float1x3 &f, int)
{
	float1x3 tmp = f;
	f = f + float1x3(1.0f);
	return tmp;
}
hlslpp_inline float1x4 operator++(float1x4 &f, int)
{
	float1x4 tmp = f;
	f = f + float1x4(1.0f);
	return tmp;
}
hlslpp_inline float2x1 operator++(float2x1 &f, int)
{
	float2x1 tmp = f;
	f = f + float2x1(1.0f);
	return tmp;
}
hlslpp_inline float3x1 operator++(float3x1 &f, int)
{
	float3x1 tmp = f;
	f = f + float3x1(1.0f);
	return tmp;
}
hlslpp_inline float4x1 operator++(float4x1 &f, int)
{
	float4x1 tmp = f;
	f = f + float4x1(1.0f);
	return tmp;
}
hlslpp_inline float2x2 operator++(float2x2 &f, int)
{
	float2x2 tmp = f;
	f = f + float2x2(1.0f);
	return tmp;
}
hlslpp_inline float2x3 operator++(float2x3 &f, int)
{
	float2x3 tmp = f;
	f = f + float2x3(1.0f);
	return tmp;
}
hlslpp_inline float3x2 operator++(float3x2 &f, int)
{
	float3x2 tmp = f;
	f = f + float3x2(1.0f);
	return tmp;
}
hlslpp_inline float2x4 operator++(float2x4 &f, int)
{
	float2x4 tmp = f;
	f = f + float2x4(1.0f);
	return tmp;
}
hlslpp_inline float4x2 operator++(float4x2 &f, int)
{
	float4x2 tmp = f;
	f = f + float4x2(1.0f);
	return tmp;
}
hlslpp_inline float3x3 operator++(float3x3 &f, int)
{
	float3x3 tmp = f;
	f = f + float3x3(1.0f);
	return tmp;
}
hlslpp_inline float3x4 operator++(float3x4 &f, int)
{
	float3x4 tmp = f;
	f = f + float3x4(1.0f);
	return tmp;
}
hlslpp_inline float4x3 operator++(float4x3 &f, int)
{
	float4x3 tmp = f;
	f = f + float4x3(1.0f);
	return tmp;
}
hlslpp_inline float4x4 operator++(float4x4 &f, int)
{
	float4x4 tmp = f;
	f = f + float4x4(1.0f);
	return tmp;
