...
struct hlslpp_nodiscard float1
{
	...
	template <int X>
	hlslpp_inline float1(const swizzle1<X> &s) hlslpp_noexcept
	...
	hlslpp_inline float1 &operator=(const float1 &f) hlslpp_noexcept
	{
		vec = f.vec;
		return *this;
	}
	...
	hlslpp_inline float1 &operator=(float1 &&f) hlslpp_noexcept
	{
		vec = f.vec;
		return *this;
	}
...
struct hlslpp_nodiscard float2
{
	...
	template <int X, int Y>
	hlslpp_inline float2(const swizzle2<X, Y> &s) hlslpp_noexcept
	...
	hlslpp_inline float2 &operator=(const float2 &f) hlslpp_noexcept
	{
		vec = f.vec;
		return *this;
	}
	...
	hlslpp_inline float2 &operator=(float2 &&f) hlslpp_noexcept
	{
		vec = f.vec;
		return *this;
	}
...
struct hlslpp_nodiscard float3
{
	...
	hlslpp_inline float3 &operator=(const float3 &f) hlslpp_noexcept
	{
		vec = f.vec;
		return *this;
	}
	...
	hlslpp_inline float3 &operator=(float3 &&f) hlslpp_noexcept
	{
		vec = f.vec;
		return *this;
	}
...
struct hlslpp_nodiscard float4
{
	...
	hlslpp_inline float4 &operator=(const float4 &f) hlslpp_noexcept
	{
		vec = f.vec;
		return *this;
	}
	...
	hlslpp_inline float4 &operator=(float4 &&f) hlslpp_noexcept
	{
		vec = f.vec;
		return *this;
	}
