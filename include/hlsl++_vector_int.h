...
hlslpp_inline int1 &operator++(int1 &i)
{
	i = i + int1(i4_1);
	return i;
}
hlslpp_inline int2 &operator++(int2 &i)
{
	i = i + int2(i4_1);
	return i;
}
hlslpp_inline int3 &operator++(int3 &i)
{
	i = i + int3(i4_1);
	return i;
}
hlslpp_inline int4 &operator++(int4 &i)
{
	i = i + int4(i4_1);
	return i;
}
...
template <int X>
hlslpp_inline iswizzle1<X> &operator++(iswizzle1<X> &i)
{
	i = i + int1(i4_1);
	return i;
}
template <int X, int Y>
hlslpp_inline iswizzle2<X, Y> &operator++(iswizzle2<X, Y> &i)
{
	i = i + int2(i4_1);
	return i;
}
template <int X, int Y, int Z>
hlslpp_inline iswizzle3<X, Y, Z> &operator++(iswizzle3<X, Y, Z> &i)
{
	i = i + int3(i4_1);
	return i;
}
template <int X, int Y, int Z, int W>
hlslpp_inline iswizzle4<X, Y, Z, W> &operator++(iswizzle4<X, Y, Z, W> &i)
{
	i = i + int4(i4_1);
	return i;
}
...
hlslpp_inline int1 operator++(int1 &i, int)
{
	int1 tmp = i;
	i = i + int1(i4_1);
	return tmp;
}
hlslpp_inline int2 operator++(int2 &i, int)
{
	int2 tmp = i;
	i = i + int2(i4_1);
	return tmp;
}
hlslpp_inline int3 operator++(int3 &i, int)
{
	int3 tmp = i;
	i = i + int3(i4_1);
	return tmp;
}
hlslpp_inline int4 operator++(int4 &i, int)
{
	int4 tmp = i;
	i = i + int4(i4_1);
	return tmp;
...
template <int X>
hlslpp_inline iswizzle1<X> operator++(iswizzle1<X> &i, int)
{
	iswizzle1<X> tmp = i;
	i = i + int1(i4_1);
	return tmp;
...
template <int X, int Y>
hlslpp_inline iswizzle2<X, Y> operator++(iswizzle2<X, Y> &i, int)
{
	iswizzle2<X, Y> tmp = i;
	i = i + int2(i4_1);
	return tmp;
...
template <int X, int Y, int Z>
hlslpp_inline iswizzle3<X, Y, Z> operator++(iswizzle3<X, Y, Z> &i, int)
{
	iswizzle3<X, Y, Z> tmp = i;
	i = i + int3(i4_1);
	return tmp;
}
template <int X, int Y, int Z, int W>
hlslpp_inline iswizzle4<X, Y, Z, W> operator++(iswizzle4<X, Y, Z, W> &i, int)
{
	iswizzle4<X, Y, Z, W> tmp = i;
	i = i + int4(i4_1);
	return tmp;
}
...
template <typename T>
hlslpp_inline hlslpp_enable_if_return(T, int1) operator+(const int1 &i1, T i2) { return i1 + int1(i2); }
template <typename T>
hlslpp_inline hlslpp_enable_if_return(T, int2) operator+(const int2 &i1, T i2) { return i1 + int2(i2); }
template <typename T>
hlslpp_inline hlslpp_enable_if_return(T, int3) operator+(const int3 &i1, T i2) { return i1 + int3(i2); }
template <typename T>
hlslpp_inline hlslpp_enable_if_return(T, int4) operator+(const int4 &i1, T i2) { return i1 + int4(i2); }

template <typename T>
hlslpp_inline hlslpp_enable_if_return(T, int1) operator+(T i1, const int1 &i2) { return int1(i1) + i2; }
template <typename T>
hlslpp_inline hlslpp_enable_if_return(T, int2) operator+(T i1, const int2 &i2) { return int2(i1) + i2; }
template <typename T>
hlslpp_inline hlslpp_enable_if_return(T, int3) operator+(T i1, const int3 &i2) { return int3(i1) + i2; }
template <typename T>
hlslpp_inline hlslpp_enable_if_return(T, int4) operator+(T i1, const int4 &i2) { return int4(i1) + i2; }
...
template <int X>
hlslpp_inline int1 operator+(const iswizzle1<X> &s, const int1 &i) { return int1(s) + i; }
template <int X>
hlslpp_inline int1 operator-(const iswizzle1<X> &s, const int1 &i) { return int1(s) - i; }
template <int X>
hlslpp_inline int1 operator*(const iswizzle1<X> &s, const int1 &i) { return int1(s) * i; }
...
hlslpp_inline int1 &operator+=(int1 &i1, const int1 &i2)
{
	i1 = i1 + i2;
	return i1;
}
hlslpp_inline int2 &operator+=(int2 &i1, const int2 &i2)
{
	i1 = i1 + i2;
	return i1;
}
hlslpp_inline int3 &operator+=(int3 &i1, const int3 &i2)
{
	i1 = i1 + i2;
	return i1;
}
hlslpp_inline int4 &operator+=(int4 &i1, const int4 &i2)
{
	i1 = i1 + i2;
	return i1;
}
...
template <int X>
hlslpp_inline iswizzle1<X> &operator+=(iswizzle1<X> &s, const int1 &i)
{
	s = int1(s) + i;
	return s;
}
...
template <int X, int Y>
hlslpp_inline iswizzle2<X, Y> &operator+=(iswizzle2<X, Y> &s, const int2 &i)
{
	s = int2(s) + i;
	return s;
}
...
template <int X, int Y, int Z>
hlslpp_inline iswizzle3<X, Y, Z> &operator+=(iswizzle3<X, Y, Z> &s, const int3 &i)
{
	s = int3(s) + i;
	return s;
}
...
template <int X, int Y, int Z, int W>
hlslpp_inline iswizzle4<X, Y, Z, W> &operator+=(iswizzle4<X, Y, Z, W> &s, const int4 &i)
{
	s = int4(s) + i;
	return s;
}
...
template <typename T>
hlslpp_inline hlslpp_enable_if_return(T, int1) operator==(const int1 &f1, T f2) { return f1 == int1(f2); }
template <typename T>
hlslpp_inline hlslpp_enable_if_return(T, int1) operator==(T f1, const int1 &f2) { return int1(f1) == f2; }

template <int X>
hlslpp_inline int1 operator-(const iswizzle1<X> &s) { return -int1(s); }

template <int X>
hlslpp_inline int1 abs(const iswizzle1<X> &s) { return abs(int1(s)); }

template <int X, int Y>
hlslpp_inline int1 operator==(const iswizzle1<X> &i1, const iswizzle1<Y> &i2) { return int1(i1) == int1(i2); }
template <int X, int Y>
hlslpp_inline int1 operator!=(const iswizzle1<X> &i1, const iswizzle1<Y> &i2) { return int1(i1) != int1(i2); }
template <int X, int Y>
hlslpp_inline int1 operator>(const iswizzle1<X> &i1, const iswizzle1<Y> &i2) { return int1(i1) > int1(i2); }
...
{
	vec = _hlslpp_blend_epi32(vec, hlslpp_iswizzle1_swizzle(0, X, i.vec), HLSLPP_COMPONENT_X(X));
	return *this;
}
