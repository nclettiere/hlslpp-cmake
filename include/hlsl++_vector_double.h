...
hlslpp_inline double1 &operator+=(double1 &f1, const double1 &f2)
{
	f1 = f1 + f2;
	return f1;
}
hlslpp_inline double2 &operator+=(double2 &f1, const double2 &f2)
{
	f1 = f1 + f2;
	return f1;
}
hlslpp_inline double3 &operator+=(double3 &f1, const double3 &f2)
{
	f1 = f1 + f2;
	return f1;
}
hlslpp_inline double4 &operator+=(double4 &f1, const double4 &f2)
{
	f1 = f1 + f2;
	return f1;
}
...
hlslpp_inline double1 &operator++(double1 &f)
{
	f = f + double1(1.0);
	return f;
}
hlslpp_inline double2 &operator++(double2 &f)
{
	f = f + double2(1.0);
	return f;
}
hlslpp_inline double3 &operator++(double3 &f)
{
	f = f + double3(1.0);
	return f;
}
hlslpp_inline double4 &operator++(double4 &f)
{
	f = f + double4(1.0);
	return f;
}
...
template <int X>
hlslpp_inline dswizzle1<X> &operator++(dswizzle1<X> &f)
{
	f = f + double1(1.0);
	return f;
}
template <int X, int Y>
hlslpp_inline dswizzle2<X, Y> &operator++(dswizzle2<X, Y> &f)
{
	f = f + double2(1.0);
	return f;
}
template <int X, int Y, int Z>
hlslpp_inline dswizzle3<X, Y, Z> &operator++(dswizzle3<X, Y, Z> &f)
{
	f = f + double3(1.0);
	return f;
}
template <int X, int Y, int Z, int W>
hlslpp_inline dswizzle4<X, Y, Z, W> &operator++(dswizzle4<X, Y, Z, W> &f)
{
	f = f + double4(1.0);
	return f;
}
...
hlslpp_inline double1 operator++(double1 &f, int)
{
	double1 tmp = f;
	f = f + double1(1.0);
	return tmp;
}
hlslpp_inline double2 operator++(double2 &f, int)
{
	double2 tmp = f;
	f = f + double2(1.0);
	return tmp;
}
hlslpp_inline double3 operator++(double3 &f, int)
{
	double3 tmp = f;
	f = f + double3(1.0);
	return tmp;
}
hlslpp_inline double4 operator++(double4 &f, int)
{
	double4 tmp = f;
	f = f + double4(1.0);
	return tmp;
...
template <int X>
hlslpp_inline dswizzle1<X> operator++(dswizzle1<X> &f, int)
{
	dswizzle1<X> tmp = f;
	f = f + double1(1.0);
	return tmp;
...
template <int X, int Y>
hlslpp_inline dswizzle2<X, Y> operator++(dswizzle2<X, Y> &f, int)
{
	dswizzle2<X, Y> tmp = f;
	f = f + double2(1.0);
	return tmp;
...
template <int X, int Y, int Z>
hlslpp_inline dswizzle3<X, Y, Z> operator++(dswizzle3<X, Y, Z> &f, int)
{
	dswizzle3<X, Y, Z> tmp = f;
	f = f + double3(1.0);
	return tmp;
}
template <int X, int Y, int Z, int W>
hlslpp_inline dswizzle4<X, Y, Z, W> operator++(dswizzle4<X, Y, Z, W> &f, int)
{
	dswizzle4<X, Y, Z, W> tmp = f;
	f = f + double4(1.0);
	return tmp;
}
...
template <typename T>
hlslpp_inline hlslpp_enable_if_return(T, double1) operator+(const double1 &f1, T f2) { return f1 + double1(f2); }
template <typename T>
hlslpp_inline hlslpp_enable_if_return(T, double2) operator+(const double2 &f1, T f2) { return f1 + double2(f2); }
template <typename T>
hlslpp_inline hlslpp_enable_if_return(T, double3) operator+(const double3 &f1, T f2) { return f1 + double3(f2); }
template <typename T>
hlslpp_inline hlslpp_enable_if_return(T, double4) operator+(const double4 &f1, T f2) { return f1 + double4(f2); }

template <typename T>
hlslpp_inline hlslpp_enable_if_return(T, double1) operator+(T f1, const double1 &f2) { return double1(f1) + f2; }
template <typename T>
hlslpp_inline hlslpp_enable_if_return(T, double2) operator+(T f1, const double2 &f2) { return double2(f1) + f2; }
template <typename T>
hlslpp_inline hlslpp_enable_if_return(T, double3) operator+(T f1, const double3 &f2) { return double3(f1) + f2; }
template <typename T>
hlslpp_inline hlslpp_enable_if_return(T, double4) operator+(T f1, const double4 &f2) { return double4(f1) + f2; }
...
template <int X>
hlslpp_inline double1 operator+(const dswizzle1<X> &s, const double1 &f) { return double1(s) + f; }
template <int X>
hlslpp_inline double1 operator-(const dswizzle1<X> &s, const double1 &f) { return double1(s) - f; }
template <int X>
hlslpp_inline double1 operator*(const dswizzle1<X> &s, const double1 &f) { return double1(s) * f; }
...
template <int X>
hlslpp_inline dswizzle1<X> &operator+=(dswizzle1<X> &s, const double1 &f)
{
	s = double1(s) + f;
	return s;
}
...
template <int X, int Y>
hlslpp_inline dswizzle2<X, Y> &operator+=(dswizzle2<X, Y> &s, const double2 &f)
{
	s = double2(s) + f;
	return s;
}
...
template <int X, int Y, int Z>
hlslpp_inline dswizzle3<X, Y, Z> &operator+=(dswizzle3<X, Y, Z> &s, const double3 &f)
{
	s = double3(s) + f;
	return s;
}
...
template <int X, int Y, int Z, int W>
hlslpp_inline dswizzle4<X, Y, Z, W> &operator+=(dswizzle4<X, Y, Z, W> &s, const double4 &f)
{
	s = double4(s) + f;
	return s;
}
...
template <int X>
hlslpp_inline double1 operator-(const dswizzle1<X> &s) { return -double1(s); }

template <int X>
hlslpp_inline double1 abs(const dswizzle1<X> &s) { return abs(double1(s)); }

template <int X>
hlslpp_inline double1 ceil(const dswizzle1<X> &s) { return ceil(double1(s)); }
template <int X>
hlslpp_inline double1 floor(const dswizzle1<X> &s) { return floor(double1(s)); }
template <int X>
hlslpp_inline double1 sqrt(const dswizzle1<X> &s) { return sqrt(double1(s)); }
