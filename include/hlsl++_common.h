...
#define hlslpp_enable_if_return(T, R) typename enable_if<is_arithmetic<T>::value, R>::type

#define hlslpp_enable_if_number(T) typename enable_if<is_arithmetic<T>::value, void *>::type = nullptr

#define hlslpp_enable_if_number_2(T1, T2) \
	typename enable_if<is_arithmetic2<T1, T2>::value, void *>::type = nullptr

#define hlslpp_enable_if_number_3(T1, T2, T3) \
	typename enable_if<is_arithmetic3<T1, T2, T3>::value, void *>::type = nullptr

#define hlslpp_enable_if_number_4(T1, T2, T3, T4) \
	typename enable_if<is_arithmetic4<T1, T2, T3, T4>::value, void *>::type = nullptr

#define hlslpp_enable_if_number_8(T1, T2, T3, T4, T5, T6, T7, T8) \
	typename enable_if<is_arithmetic8<T1, T2, T3, T4, T5, T6, T7, T8>::value, void *>::type = nullptr
