...
hlslpp_inline float1 &operator+=(float1 &f1, const float1 &f2)
{
	f1 = f1 + f2;
	return f1;
}
hlslpp_inline float2 &operator+=(float2 &f1, const float2 &f2)
{
	f1 = f1 + f2;
	return f1;
}
hlslpp_inline float3 &operator+=(float3 &f1, const float3 &f2)
{
	f1 = f1 + f2;
	return f1;
}
hlslpp_inline float4 &operator+=(float4 &f1, const float4 &f2)
{
	f1 = f1 + f2;
	return f1;
}
...
hlslpp_inline float1 &operator++(float1 &f)
{
	f = f + float1(f4_1);
	return f;
}
hlslpp_inline float2 &operator++(float2 &f)
{
	f = f + float2(f4_1);
	return f;
}
hlslpp_inline float3 &operator++(float3 &f)
{
	f = f + float3(f4_1);
	return f;
}
hlslpp_inline float4 &operator++(float4 &f)
{
	f = f + float4(f4_1);
	return f;
}
...
template <int X>
hlslpp_inline swizzle1<X> &operator++(swizzle1<X> &f)
{
	f = f + float1(f4_1);
	return f;
}
template <int X, int Y>
hlslpp_inline swizzle2<X, Y> &operator++(swizzle2<X, Y> &f)
{
	f = f + float2(f4_1);
	return f;
}
template <int X, int Y, int Z>
hlslpp_inline swizzle3<X, Y, Z> &operator++(swizzle3<X, Y, Z> &f)
{
	f = f + float3(f4_1);
	return f;
}
template <int X, int Y, int Z, int W>
hlslpp_inline swizzle4<X, Y, Z, W> &operator++(swizzle4<X, Y, Z, W> &f)
{
	f = f + float4(f4_1);
	return f;
}
...
hlslpp_inline float1 operator++(float1 &f, int)
{
	float1 tmp = f;
	f = f + float1(f4_1);
	return tmp;
}
hlslpp_inline float2 operator++(float2 &f, int)
{
	float2 tmp = f;
	f = f + float2(f4_1);
	return tmp;
}
hlslpp_inline float3 operator++(float3 &f, int)
{
	float3 tmp = f;
	f = f + float3(f4_1);
	return tmp;
}
hlslpp_inline float4 operator++(float4 &f, int)
{
	float4 tmp = f;
	f = f + float4(f4_1);
	return tmp;
...
template <int X>
hlslpp_inline swizzle1<X> operator++(swizzle1<X> &f, int)
{
	swizzle1<X> tmp = f;
	f = f + float1(f4_1);
	return tmp;
...
template <int X, int Y>
hlslpp_inline swizzle2<X, Y> operator++(swizzle2<X, Y> &f, int)
{
	swizzle2<X, Y> tmp = f;
	f = f + float2(f4_1);
	return tmp;
...
template <int X, int Y, int Z>
hlslpp_inline swizzle3<X, Y, Z> operator++(swizzle3<X, Y, Z> &f, int)
{
	swizzle3<X, Y, Z> tmp = f;
	f = f + float3(f4_1);
	return tmp;
}
template <int X, int Y, int Z, int W>
hlslpp_inline swizzle4<X, Y, Z, W> operator++(swizzle4<X, Y, Z, W> &f, int)
{
	swizzle4<X, Y, Z, W> tmp = f;
	f = f + float4(f4_1);
	return tmp;
}
...
template <typename T>
hlslpp_inline hlslpp_enable_if_return(T, float1) operator+(const float1 &f1, T f2) { return f1 + float1(f2); }
template <typename T>
hlslpp_inline hlslpp_enable_if_return(T, float2) operator+(const float2 &f1, T f2) { return f1 + float2(f2); }
template <typename T>
hlslpp_inline hlslpp_enable_if_return(T, float3) operator+(const float3 &f1, T f2) { return f1 + float3(f2); }
template <typename T>
hlslpp_inline hlslpp_enable_if_return(T, float4) operator+(const float4 &f1, T f2) { return f1 + float4(f2); }

template <typename T>
hlslpp_inline hlslpp_enable_if_return(T, float1) operator+(T f1, const float1 &f2) { return float1(f1) + f2; }
template <typename T>
hlslpp_inline hlslpp_enable_if_return(T, float2) operator+(T f1, const float2 &f2) { return float2(f1) + f2; }
template <typename T>
hlslpp_inline hlslpp_enable_if_return(T, float3) operator+(T f1, const float3 &f2) { return float3(f1) + f2; }
template <typename T>
hlslpp_inline hlslpp_enable_if_return(T, float4) operator+(T f1, const float4 &f2) { return float4(f1) + f2; }
...
hlslpp_inline hlslpp_enable_if_return(T, float1) operator+(const swizzle1<X> &f1, T f2) { return float1(f1) + float1(f2); }
template <int X, typename T>
hlslpp_inline hlslpp_enable_if_return(T, float1) operator+(T f1, const swizzle1<X> &f2) { return float1(f1) + float1(f2); }
...
template <int X>
hlslpp_inline float1 operator+(const swizzle1<X> &s, const float1 &f) { return float1(s) + f; }
template <int X>
hlslpp_inline float1 operator-(const swizzle1<X> &s, const float1 &f) { return float1(s) - f; }
template <int X>
hlslpp_inline float1 operator*(const swizzle1<X> &s, const float1 &f) { return float1(s) * f; }
...
template <int X>
hlslpp_inline swizzle1<X> &operator+=(swizzle1<X> &s, const float1 &f)
{
	s = float1(s) + f;
	return s;
}
...
template <int X, int Y>
hlslpp_inline swizzle2<X, Y> &operator+=(swizzle2<X, Y> &s, const float2 &f)
{
	s = float2(s) + f;
	return s;
}
...
template <int X, int Y, int Z>
hlslpp_inline swizzle3<X, Y, Z> &operator+=(swizzle3<X, Y, Z> &s, const float3 &f)
{
	s = float3(s) + f;
	return s;
}
...
template <int X, int Y, int Z, int W>
hlslpp_inline swizzle4<X, Y, Z, W> &operator+=(swizzle4<X, Y, Z, W> &s, const float4 &f)
{
	s = float4(s) + f;
	return s;
}
...
hlslpp_inline float1 distance(const float2 &f1, const float2 &f2)
{
	n128 delta = _hlslpp_sub_ps(f2.vec, f1.vec);
	return float1(_hlslpp_sqrt_ps(_hlslpp_dot2_ps(delta, delta)));
}
hlslpp_inline float1 distance(const float3 &f1, const float3 &f2)
{
	n128 delta = _hlslpp_sub_ps(f2.vec, f1.vec);
	return float1(_hlslpp_sqrt_ps(_hlslpp_dot3_ps(delta, delta)));
}
hlslpp_inline float1 distance(const float4 &f1, const float4 &f2)
{
	n128 delta = _hlslpp_sub_ps(f2.vec, f1.vec);
	return float1(_hlslpp_sqrt_ps(_hlslpp_dot4_ps(delta, delta)));
}
...
hlslpp_inline void sincos(const float1 &f, float1 &s, float1 &c)
{
	s = float1(_hlslpp_sin_ps(f.vec));
	c = float1(_hlslpp_cos_ps(f.vec));
}
hlslpp_inline void sincos(const float2 &f, float2 &s, float2 &c)
{
	s = float2(_hlslpp_sin_ps(f.vec));
	c = float2(_hlslpp_cos_ps(f.vec));
}
hlslpp_inline void sincos(const float3 &f, float3 &s, float3 &c)
{
	s = float3(_hlslpp_sin_ps(f.vec));
	c = float3(_hlslpp_cos_ps(f.vec));
}
hlslpp_inline void sincos(const float4 &f, float4 &s, float4 &c)
{
	s = float4(_hlslpp_sin_ps(f.vec));
	c = float4(_hlslpp_cos_ps(f.vec));
}
...
template <int X>
hlslpp_inline float1 operator-(const swizzle1<X> &s) { return -float1(s); }

template <typename T>
hlslpp_inline hlslpp_enable_if_return(T, float1) fmod(const float1 &f1, T f2) { return fmod(f1, float1(f2)); }
template <typename T>
hlslpp_inline hlslpp_enable_if_return(T, float1) fmod(T f1, const float1 &f2) { return fmod(float1(f1), f2); }

template <int X, int Y>
hlslpp_inline float1 max(const swizzle1<X> &s, const swizzle1<Y> &f) { return max(float1(s), float1(f)); }
template <int X>
hlslpp_inline float1 max(const swizzle1<X> &s, const swizzle1<X> &f) { return max(float1(s), float1(f)); }

template <int X, int Y>
hlslpp_inline float1 min(const swizzle1<X> &s, const swizzle1<Y> &f) { return min(float1(s), float1(f)); }
template <int X>
hlslpp_inline float1 min(const swizzle1<X> &s, const swizzle1<X> &f) { return min(float1(s), float1(f)); }

template <typename T>
hlslpp_inline hlslpp_enable_if_return(T, float1) pow(const float1 &f1, T f2) { return pow(f1, float1(f2)); }
template <typename T>
hlslpp_inline hlslpp_enable_if_return(T, float1) pow(T f1, const float1 &f2) { return pow(float1(f1), f2); }
template <int X, int Y>
hlslpp_inline float1 pow(const swizzle1<X> &s, const swizzle1<Y> &f) { return pow(float1(s), float1(f)); }

template <int X>
hlslpp_inline float1 abs(const swizzle1<X> &s) { return abs(float1(s)); }
template <int X>
hlslpp_inline float1 acos(const swizzle1<X> &s) { return acos(float1(s)); }
template <int X>
hlslpp_inline float1 asin(const swizzle1<X> &s) { return asin(float1(s)); }
template <int X>
hlslpp_inline float1 atan(const swizzle1<X> &s) { return atan(float1(s)); }
template <int X>
hlslpp_inline float1 atan2(const swizzle1<X> &s1, const swizzle1<X> &s2) { return atan2(float1(s1), float1(s2)); }
template <int X>
hlslpp_inline float1 ceil(const swizzle1<X> &s) { return ceil(float1(s)); }
template <int X>
hlslpp_inline float1 cos(const swizzle1<X> &s) { return cos(float1(s)); }
template <int X>
hlslpp_inline float1 cosh(const swizzle1<X> &s) { return cosh(float1(s)); }
template <int X>
hlslpp_inline float1 floor(const swizzle1<X> &s) { return floor(float1(s)); }
template <int X>
hlslpp_inline float1 frac(const swizzle1<X> &s) { return frac(float1(s)); }
template <int X>
hlslpp_inline float1 exp(const swizzle1<X> &s) { return exp(float1(s)); }
template <int X>
hlslpp_inline float1 exp2(const swizzle1<X> &s) { return exp2(float1(s)); }
template <int X>
hlslpp_inline float1 log(const swizzle1<X> &s) { return log(float1(s)); }
template <int X>
hlslpp_inline float1 log2(const swizzle1<X> &s) { return log2(float1(s)); }
template <int X>
hlslpp_inline float1 log10(const swizzle1<X> &s) { return log10(float1(s)); }
template <int X>
hlslpp_inline float1 round(const swizzle1<X> &s) { return round(float1(s)); }
template <int X>
hlslpp_inline float1 sin(const swizzle1<X> &s) { return sin(float1(s)); }
template <int X>
hlslpp_inline float1 sinh(const swizzle1<X> &s) { return sinh(float1(s)); }
template <int X>
hlslpp_inline float1 sqrt(const swizzle1<X> &s) { return sqrt(float1(s)); }
template <int X>
hlslpp_inline float1 tan(const swizzle1<X> &s) { return tan(float1(s)); }
template <int X>
hlslpp_inline float1 tanh(const swizzle1<X> &s) { return tanh(float1(s)); }
template <int X>
hlslpp_inline float1 trunc(const swizzle1<X> &s) { return trunc(float1(s)); }

template <int X>
hlslpp_inline float1 isfinite(const swizzle1<X> &s) { return isfinite(float1(s)); }
template <int X>
hlslpp_inline float1 isnan(const swizzle1<X> &s) { return isnan(float1(s)); }
template <int X>
hlslpp_inline float1 isinf(const swizzle1<X> &s) { return isinf(float1(s)); }

template <int X, int Y>
hlslpp_inline float2 isfinite(const swizzle2<X, Y> &s) { return isfinite(float2(s)); }
template <int X, int Y>
hlslpp_inline float2 isinf(const swizzle2<X, Y> &s) { return isinf(float2(s)); }
template <int X, int Y>
hlslpp_inline float2 isnan(const swizzle2<X, Y> &s) { return isnan(float2(s)); }

template <int X, int Y, int Z>
hlslpp_inline float3 isfinite(const swizzle3<X, Y, Z> &s) { return isfinite(float3(s)); }
template <int X, int Y, int Z>
hlslpp_inline float3 isinf(const swizzle3<X, Y, Z> &s) { return isinf(float3(s)); }
template <int X, int Y, int Z>
hlslpp_inline float3 isnan(const swizzle3<X, Y, Z> &s) { return isnan(float3(s)); }

template <int X, int Y, int Z, int W>
hlslpp_inline float4 isfinite(const swizzle4<X, Y, Z, W> &s) { return isfinite(float4(s)); }
template <int X, int Y, int Z, int W>
hlslpp_inline float4 isinf(const swizzle4<X, Y, Z, W> &s) { return isinf(float4(s)); }
template <int X, int Y, int Z, int W>
hlslpp_inline float4 isnan(const swizzle4<X, Y, Z, W> &s) { return isnan(float4(s)); }

template <int X, int Y>
hlslpp_inline float1 operator==(const swizzle1<X> &f1, const swizzle1<Y> &f2) { return float1(f1) == float1(f2); }
template <int X, int Y>
hlslpp_inline float1 operator!=(const swizzle1<X> &f1, const swizzle1<Y> &f2) { return float1(f1) != float1(f2); }
template <int X, int Y>
hlslpp_inline float1 operator>(const swizzle1<X> &f1, const swizzle1<Y> &f2) { return float1(f1) > float1(f2); }
...
{
	vec = _hlslpp_blend_ps(vec, hlslpp_swizzle1_swizzle(0, X, f.vec), HLSLPP_COMPONENT_X(X));
	return *this;
}
