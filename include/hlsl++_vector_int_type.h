...
struct hlslpp_nodiscard int1
{
	...
	template <int X>
	hlslpp_inline int1(const iswizzle1<X> &s) hlslpp_noexcept
		: vec(hlslpp_iswizzle1_swizzle(X, 0, s.vec)) {}

	hlslpp_inline int1(const float1 &f) hlslpp_noexcept;

	hlslpp_inline int1 &operator=(const int1 &i) hlslpp_noexcept
	{
		vec = i.vec;
		return *this;
	}
	...
	hlslpp_inline int1 &operator=(int1 &&i) hlslpp_noexcept
	{
		vec = i.vec;
		return *this;
	}
...
struct hlslpp_nodiscard int2
{
	...
	template <int X, int Y>
	hlslpp_inline int2(const iswizzle2<X, Y> &s) hlslpp_noexcept
		: vec(hlslpp_iswizzle2_swizzle(X, Y, 0, 1, s.vec)) {}

	hlslpp_inline int2(const float2 &f) hlslpp_noexcept;

	hlslpp_inline int2 &operator=(const int2 &i) hlslpp_noexcept
	{
		vec = i.vec;
		return *this;
	}
	...
	hlslpp_inline int2 &operator=(int2 &&i) hlslpp_noexcept
	{
		vec = i.vec;
		return *this;
	}
...
struct hlslpp_nodiscard int3
{
	...
	hlslpp_inline int3 &operator=(const int3 &i) hlslpp_noexcept
	{
		vec = i.vec;
		return *this;
	}
	...
	hlslpp_inline int3 &operator=(int3 &&i) hlslpp_noexcept
	{
		vec = i.vec;
		return *this;
	}
...
struct hlslpp_nodiscard int4
{
	...
	hlslpp_inline int4 &operator=(const int4 &i) hlslpp_noexcept
	{
		vec = i.vec;
		return *this;
	}
	...
	hlslpp_inline int4 &operator=(int4 &&i) hlslpp_noexcept
	{
		vec = i.vec;
		return *this;
	}
