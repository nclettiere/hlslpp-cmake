...
struct hlslpp_nodiscard uint1
{
	...
	template <int X>
	hlslpp_inline uint1(const uswizzle1<X> &s) hlslpp_noexcept
		: vec(hlslpp_uswizzle1_swizzle(X, 0, s.vec)) {}

	hlslpp_inline uint1(const float1 &f) hlslpp_noexcept;

	hlslpp_inline uint1 &operator=(const uint1 &i) hlslpp_noexcept
	{
		vec = i.vec;
		return *this;
	}
	...
	hlslpp_inline uint1 &operator=(uint1 &&i) hlslpp_noexcept
	{
		vec = i.vec;
		return *this;
	}
...
struct hlslpp_nodiscard uint2
{
	...
	template <int X, int Y>
	hlslpp_inline uint2(const uswizzle2<X, Y> &s) hlslpp_noexcept
		: vec(hlslpp_uswizzle2_swizzle(X, Y, 0, 1, s.vec)) {}

	hlslpp_inline uint2(const float2 &f) hlslpp_noexcept;

	hlslpp_inline uint2 &operator=(const uint2 &i) hlslpp_noexcept
	{
		vec = i.vec;
		return *this;
	}
	...
	hlslpp_inline uint2 &operator=(uint2 &&i) hlslpp_noexcept
	{
		vec = i.vec;
		return *this;
	}
...
struct hlslpp_nodiscard uint3
{
	...
	hlslpp_inline uint3 &operator=(const uint3 &i) hlslpp_noexcept
	{
		vec = i.vec;
		return *this;
	}
	...
	hlslpp_inline uint3 &operator=(uint3 &&i) hlslpp_noexcept
	{
		vec = i.vec;
		return *this;
	}
...
struct hlslpp_nodiscard uint4
{
	...
	hlslpp_inline uint4 &operator=(const uint4 &i) hlslpp_noexcept
	{
		vec = i.vec;
		return *this;
	}
	...
	hlslpp_inline uint4 &operator=(uint4 &&i) hlslpp_noexcept
	{
		vec = i.vec;
		return *this;
	}
