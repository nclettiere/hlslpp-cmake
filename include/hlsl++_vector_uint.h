...
hlslpp_inline uint1 &operator++(uint1 &i)
{
	i = i + uint1(1);
	return i;
}
hlslpp_inline uint2 &operator++(uint2 &i)
{
	i = i + uint2(1);
	return i;
}
hlslpp_inline uint3 &operator++(uint3 &i)
{
	i = i + uint3(1);
	return i;
}
hlslpp_inline uint4 &operator++(uint4 &i)
{
	i = i + uint4(1);
	return i;
}
...
template <int X>
hlslpp_inline uswizzle1<X> &operator++(uswizzle1<X> &i)
{
	i = i + uint1(u4_1);
	return i;
}
template <int X, int Y>
hlslpp_inline uswizzle2<X, Y> &operator++(uswizzle2<X, Y> &i)
{
	i = i + uint2(u4_1);
	return i;
}
template <int X, int Y, int Z>
hlslpp_inline uswizzle3<X, Y, Z> &operator++(uswizzle3<X, Y, Z> &i)
{
	i = i + uint3(u4_1);
	return i;
}
template <int X, int Y, int Z, int W>
hlslpp_inline uswizzle4<X, Y, Z, W> &operator++(uswizzle4<X, Y, Z, W> &i)
{
	i = i + uint4(u4_1);
	return i;
}
...
hlslpp_inline uint1 operator++(uint1 &i, int)
{
	uint1 tmp = i;
	i = i + uint1(1);
	return tmp;
}
hlslpp_inline uint2 operator++(uint2 &i, int)
{
	uint2 tmp = i;
	i = i + uint2(1);
	return tmp;
}
hlslpp_inline uint3 operator++(uint3 &i, int)
{
	uint3 tmp = i;
	i = i + uint3(1);
	return tmp;
}
hlslpp_inline uint4 operator++(uint4 &i, int)
{
	uint4 tmp = i;
	i = i + uint4(1);
	return tmp;
...
template <int X>
hlslpp_inline uswizzle1<X> operator++(uswizzle1<X> &i, int)
{
	uswizzle1<X> tmp = i;
	i = i + uint1(u4_1);
	return tmp;
...
template <int X, int Y>
hlslpp_inline uswizzle2<X, Y> operator++(uswizzle2<X, Y> &i, int)
{
	uswizzle2<X, Y> tmp = i;
	i = i + uint2(u4_1);
	return tmp;
...
template <int X, int Y, int Z>
hlslpp_inline uswizzle3<X, Y, Z> operator++(uswizzle3<X, Y, Z> &i, int)
{
	uswizzle3<X, Y, Z> tmp = i;
	i = i + uint3(u4_1);
	return tmp;
}
template <int X, int Y, int Z, int W>
hlslpp_inline uswizzle4<X, Y, Z, W> operator++(uswizzle4<X, Y, Z, W> &i, int)
{
	uswizzle4<X, Y, Z, W> tmp = i;
	i = i + uint4(u4_1);
	return tmp;
}
...
template <typename T>
hlslpp_inline hlslpp_enable_if_return(T, uint1) operator+(const uint1 &i1, T i2) { return i1 + uint1(i2); }
template <typename T>
hlslpp_inline hlslpp_enable_if_return(T, uint2) operator+(const uint2 &i1, T i2) { return i1 + uint2(i2); }
template <typename T>
hlslpp_inline hlslpp_enable_if_return(T, uint3) operator+(const uint3 &i1, T i2) { return i1 + uint3(i2); }
template <typename T>
hlslpp_inline hlslpp_enable_if_return(T, uint4) operator+(const uint4 &i1, T i2) { return i1 + uint4(i2); }

template <typename T>
hlslpp_inline hlslpp_enable_if_return(T, uint1) operator+(T i1, const uint1 &i2) { return uint1(i1) + i2; }
template <typename T>
hlslpp_inline hlslpp_enable_if_return(T, uint2) operator+(T i1, const uint2 &i2) { return uint2(i1) + i2; }
template <typename T>
hlslpp_inline hlslpp_enable_if_return(T, uint3) operator+(T i1, const uint3 &i2) { return uint3(i1) + i2; }
template <typename T>
hlslpp_inline hlslpp_enable_if_return(T, uint4) operator+(T i1, const uint4 &i2) { return uint4(i1) + i2; }
...
template <int X>
hlslpp_inline uint1 operator+(const uswizzle1<X> &s, const uint1 &i) { return uint1(s) + i; }
template <int X>
hlslpp_inline uint1 operator-(const uswizzle1<X> &s, const uint1 &i) { return uint1(s) - i; }
template <int X>
hlslpp_inline uint1 operator*(const uswizzle1<X> &s, const uint1 &i) { return uint1(s) * i; }
...
hlslpp_inline uint1 &operator+=(uint1 &i1, const uint1 &i2)
{
	i1 = i1 + i2;
	return i1;
}
hlslpp_inline uint2 &operator+=(uint2 &i1, const uint2 &i2)
{
	i1 = i1 + i2;
	return i1;
}
hlslpp_inline uint3 &operator+=(uint3 &i1, const uint3 &i2)
{
	i1 = i1 + i2;
	return i1;
}
hlslpp_inline uint4 &operator+=(uint4 &i1, const uint4 &i2)
{
	i1 = i1 + i2;
	return i1;
}
...
template <int X>
hlslpp_inline uswizzle1<X> &operator+=(uswizzle1<X> &s, const uint1 &i)
{
	s = uint1(s) + i;
	return s;
}
...
template <int X, int Y>
hlslpp_inline uswizzle2<X, Y> &operator+=(uswizzle2<X, Y> &s, const uint2 &i)
{
	s = uint2(s) + i;
	return s;
}
...
template <int X, int Y, int Z>
hlslpp_inline uswizzle3<X, Y, Z> &operator+=(uswizzle3<X, Y, Z> &s, const uint3 &i)
{
	s = uint3(s) + i;
	return s;
}
...
template <int X, int Y, int Z, int W>
hlslpp_inline uswizzle4<X, Y, Z, W> &operator+=(uswizzle4<X, Y, Z, W> &s, const uint4 &i)
{
	s = uint4(s) + i;
	return s;
}
...
template <typename T>
hlslpp_inline hlslpp_enable_if_return(T, uint1) operator==(const uint1 &f1, T f2) { return f1 == uint1(f2); }
template <typename T>
hlslpp_inline hlslpp_enable_if_return(T, uint1) operator==(T f1, const uint1 &f2) { return uint1(f1) == f2; }

template <int X, int Y>
hlslpp_inline uint1 operator==(const uswizzle1<X> &i1, const uswizzle1<Y> &i2) { return uint1(i1) == uint1(i2); }
template <int X, int Y>
hlslpp_inline uint1 operator!=(const uswizzle1<X> &i1, const uswizzle1<Y> &i2) { return uint1(i1) != uint1(i2); }
template <int X, int Y>
hlslpp_inline uint1 operator>(const uswizzle1<X> &i1, const uswizzle1<Y> &i2) { return uint1(i1) > uint1(i2); }
...
{
	vec = _hlslpp_blend_epi32(vec, hlslpp_uswizzle1_swizzle(0, X, i.vec), HLSLPP_COMPONENT_X(X));
	return *this;
}
